    ...
    *,
    ...
    if field.shape in {
        ...
        if field.shape == SHAPE_GENERIC:
            all_of_schemas = (
                sub_schema[0] if sub_fields_len == 1 else {"type": "array", "items": sub_schema}
            )
    ...
    *,
    ...
    if len(sub_fields) == 1:
        ...
        if field_has_discriminator:
            ...
            s["discriminator"] = {
                "propertyName": (
                    field.discriminator_alias if by_alias else field.discriminator_key
                ),
...
def multitypes_literal_field_for_schema(values: Tuple[Any, ...], field: ModelField) -> ModelField:
    ...
    distinct_literals = (
        Literal[tuple(same_type_values)] for same_type_values in literal_distinct_types.values()
    )
