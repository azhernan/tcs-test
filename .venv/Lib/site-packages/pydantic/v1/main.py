        ...
        if (namespace.get("__module__"), namespace.get("__qualname__")) != (
            ...
            for ann_name, ann_type in annotations.items():
                if is_classvar(ann_type):
                    ...
                    allowed_types = (
                        get_args(ann_type) if is_union(get_origin(ann_type)) else (ann_type,)
                    )
                    if (
                        is_untouched(value)
...
class BaseModel(Representation, metaclass=ModelMetaclass):
    ...
    def copy(
        ...
        *,
        ...
        values = dict(
            self._iter(
                to_dict=False, by_alias=False, include=include, exclude=exclude, exclude_unset=False
            ),
            **(update or {}),
        )
    ...
    def __try_update_forward_refs__(cls, **localns: Any) -> None:
        ...
        """
        update_model_forward_refs(
            cls, cls.__fields__.values(), cls.__config__.json_encoders, localns, (NameError,)
        )
