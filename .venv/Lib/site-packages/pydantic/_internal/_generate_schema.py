...
class GenerateSchema:
    ...
    def _fraction_schema(self) -> CoreSchema:
        ...
        return core_schema.lax_or_strict_schema(
            ...
            metadata={
                "pydantic_js_functions": [lambda _1, _2: {"type": "string", "format": "fraction"}]
            },
        )
    ...
    def _get_args_resolving_forward_refs(
        ...
        if args:
            if isinstance(obj, GenericAlias):
                ...
                args = (
                    _typing_extra._make_forward_ref(a) if isinstance(a, str) else a for a in args
                )
            args = tuple(
            ...
            with self._config_wrapper_stack.push(config):
                ...
                if (config_extra := self._config_wrapper.extra) in ("allow", "forbid"):
                    if is_closed and config_extra == "allow":
                        ...
                        not typing_objects.is_noextraitems(extra_items) and config_extra == "forbid"
                    ):
                        warnings.warn(
    ...
    def _zoneinfo_schema(self) -> core_schema.CoreSchema:
        ...
        metadata = {
            "pydantic_js_functions": [lambda _1, _2: {"type": "string", "format": "zoneinfo"}]
        }
