        ...
        **kwargs: Any,
        ...
        if bases:
            ...
            cls.__pydantic_post_init__ = (
                None if cls.model_post_init is BaseModel.model_post_init else "model_post_init"
            )
...
def set_deprecated_descriptors(cls: type[BaseModel]) -> None:
    ...
    for field, computed_field_info in cls.model_computed_fields.items():
        if (
            ...
            and not hasattr(
                unwrap_wrapped_function(computed_field_info.wrapped_property), "__deprecated__"
            )
        ):
