...
def _frame_depth(
    ...
    [Callable[Concatenate[TypeAdapterT, P], R]], Callable[Concatenate[TypeAdapterT, P], R]
]:
    def wrapper(
...
class TypeAdapter(Generic[T]):
    ...
    **Note:** By default, `TypeAdapter` does not respect the
    ...
    def validate_python(
        ...
        *,
        ...
        return self.validator.validate_python(
            object, strict=strict, from_attributes=from_attributes, context=context
        )
    ...
    def validate_strings(
        self, obj: Any, /, *, strict: bool | None = None, context: dict[str, Any] | None = None
    ) -> T:
