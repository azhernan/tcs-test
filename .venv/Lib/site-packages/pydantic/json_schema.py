...
class GenerateJsonSchema:
    ...
    def generate_inner(self, schema: CoreSchemaOrField) -> JsonSchemaValue:  # noqa: C901
        ...
        def handler_func(schema_or_field: CoreSchemaOrField) -> JsonSchemaValue:
            ...
            if json_schema is None:
                if _core_utils.is_core_schema(schema_or_field) or _core_utils.is_core_schema_field(
                    schema_or_field
                ):
    ...
    def list_schema(self, schema: core_schema.ListSchema) -> JsonSchemaValue:
        ...
        """
        items_schema = (
            {} if "items_schema" not in schema else self.generate_inner(schema["items_schema"])
        )
    ...
    @deprecated(
        "`tuple_positional_schema` is deprecated. Use `tuple_schema` instead.", category=None
    )
    @final
    ...
    def dict_schema(self, schema: core_schema.DictSchema) -> JsonSchemaValue:
        ...
        values_schema = (
            self.generate_inner(schema["values_schema"]).copy() if "values_schema" in schema else {}
        )
    ...
    def _update_class_schema(
        ...
        if "$ref" in json_schema:
            schema_to_update = (
                self.get_schema_from_definitions(JsonRef(json_schema["$ref"])) or json_schema
            )
        else:
...
def models_json_schema(
    ...
    *,
    ...
    dict[tuple[type[BaseModel] | type[PydanticDataclass], JsonSchemaMode], JsonSchemaValue],
    JsonSchemaValue,
]:
...
class Examples:
    ...
    @overload
    def __init__(
        self, examples: list[Any], mode: Literal["validation", "serialization"] | None = None
    ) -> None: ...
