...
class Properties(Generic[_T]):
    ...
    def get(self, key: str, default: Optional[Union[_DT, _T]] = None) -> Optional[Union[_T, _DT]]:
        if key in self:
            return self[key]
        else:
            return default
...
class LRUCache(typing.MutableMapping[_KT, _VT]):
    ...
    def get(self, key: _KT, default: Optional[Union[_VT, _T]] = None) -> Optional[Union[_VT, _T]]:
