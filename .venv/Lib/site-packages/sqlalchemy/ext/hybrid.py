...
class _HybridExprCallableType(Protocol[_T_co]):
    def __call__(s, cls: Any) -> Union[_HasClauseElement[_T_co], SQLColumnExpression[_T_co]]: ...
...
class Comparator(interfaces.PropComparator[_T]):
    ...
    def __init__(self, expression: Union[_HasClauseElement[_T], SQLColumnExpression[_T]]):
