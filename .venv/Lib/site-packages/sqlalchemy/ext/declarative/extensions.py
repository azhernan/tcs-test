    ...
    def prepare(cls, bind: Union[Engine, Connection], **reflect_kw: Any) -> None:
        ...
        for thingy in to_map:
            if thingy.local_table is not None:
                metadata_to_table[(thingy.local_table.metadata, thingy.local_table.schema)].add(
                    thingy.local_table.name
                )
                ...
                for rel in mapper._props.values():
                    if (
                        ...
                        if isinstance(secondary_arg.argument, Table):
                            ...
                            metadata_to_table[(metadata, thingy.local_table.schema)].add(
                                secondary_arg.argument
                            )
