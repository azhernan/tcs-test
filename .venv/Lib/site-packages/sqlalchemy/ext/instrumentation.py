    ...
    def _check_conflicts(self, class_, factory):
        ...
        if existing_factories:
            raise TypeError(
                ...
                "in %s inheritance hierarchy: %r" % (class_.__name__, list(existing_factories))
            )
...
def _install_lookups(lookups):
    ...
    orm_base.instance_state = attributes.instance_state = orm_instrumentation.instance_state = (
        instance_state
    )
    orm_base.instance_dict = attributes.instance_dict = orm_instrumentation.instance_dict = (
        instance_dict
    )
