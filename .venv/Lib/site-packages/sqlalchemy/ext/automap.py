...
class GenerateRelationshipType(Protocol):
    ...
    def __call__(
        ...
        base: Type[Any],
        direction: RelationshipDirection,
        return_fn: Union[Callable[..., Relationship[Any]], Callable[..., ORMBackrefArgument]],
        attrname: str,
        local_cls: Type[Any],
        referred_cls: Type[Any],
        **kw: Any,
...
class AutomapBase:
    ...
    def prepare(
        ...
        name_for_collection_relationship: Optional[NameForCollectionRelationshipType] = None,
        generate_relationship: Optional[GenerateRelationshipType] = None,
        reflection_options: Union[Dict[_KT, _VT], immutabledict[_KT, _VT]] = util.EMPTY_DICT,
    ) -> None:
...
def _is_many_to_many(
    ...
    cols: List[Column[Any]] = sum(
        [[fk.parent for fk in fk_constraint.elements] for fk_constraint in fk_constraints],
        [],
    )
...
def _relationships_for_fks(
    ...
    local_cls = cast("Optional[Type[Any]]", map_config.cls)  # derived from a weakref, may be None
