            ...
            if obj is not None:
                ...
                # if they are empty
                    ...
                    if meth is CACHE_IN_PLACE:
                        ...
                        result += meth(attrname, obj, self, anon_map, bindparams)  # type: ignore
        return result
...
class CacheKey(NamedTuple):
    ...
    def to_offline_string(
        ...
        if not self.bindparams:
            ...
            param_tuple = tuple(
                parameters.get(bindparam.key, bindparam.value) for bindparam in self.bindparams
            )
...
class _CacheKeyTraversal(HasTraversalDispatch):
    ...
    def visit_multi(
        ...
        return (
            attrname,
            (obj._gen_cache_key(anon_map, bindparams) if isinstance(obj, HasCacheKey) else obj),
        )
    ...
    def visit_executable_options(
        ...
        return (
            attrname,
            tuple(
                elem._gen_cache_key(anon_map, bindparams) for elem in obj if elem._is_has_cache_key
            ),
        )
    ...
    def visit_prefix_sequence(
        ...
        return (
            attrname,
            tuple(
                [(clause._gen_cache_key(anon_map, bindparams), strval) for clause, strval in obj]
            ),
        )
    ...
    def visit_setup_join_tuple(
        ...
        return tuple(
            (
                ...
                (onclause._gen_cache_key(anon_map, bindparams) if onclause is not None else None),
                (from_._gen_cache_key(anon_map, bindparams) if from_ is not None else None),
    ...
    def visit_dialect_options(
        ...
        return (
            ...
            tuple(
                (
                    dialect_name,
                    tuple([(key, obj[dialect_name][key]) for key in sorted(obj[dialect_name])]),
                )
    ...
    def visit_string_clauseelement_dict(
        ...
        return (
            attrname,
            tuple((key, obj[key]._gen_cache_key(anon_map, bindparams)) for key in sorted(obj)),
        )
    ...
    def visit_fromclause_canonical_column_collection(
        ...
        return (
            attrname,
            tuple(col._gen_cache_key(anon_map, bindparams) for k, col, _ in obj._collection),
        )
