...
def _match_impl(
    ...
    return _boolean_compare(
        ...
        negate_op=(operators.not_match_op if op is operators.match_op else operators.match_op),
        **kw,
    )
...
def _between_impl(
    ...
    **kw: Any,
    ...
    return BinaryExpression(
        ...
        op,
        negate=(operators.not_between_op if op is operators.between_op else operators.between_op),
        modifiers=kw,
    )
