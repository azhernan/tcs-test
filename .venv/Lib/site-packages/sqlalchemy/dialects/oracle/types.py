...
class FLOAT(sqltypes.FLOAT):
    ...
    def __init__(
        ...
        """
        super().__init__(asdecimal=asdecimal, decimal_return_scale=decimal_return_scale)
    ...
    def _literal_processor_date(self, dialect):
        def process(value):
            if getattr(value, "microsecond", None):
                ...
                value = (
                    f"""TO_DATE""" f"""('{value.isoformat().split("T")[0]}', """ """'YYYY-MM-DD')"""
                )
            return value
...
class INTERVAL(sqltypes.NativeForEmulated, sqltypes._AbstractInterval):
    ...
    @classmethod
    def adapt_emulated_to_native(cls, interval: sqltypes.Interval, **kw):  # type: ignore[override]
        return INTERVAL(
            day_precision=interval.day_precision,
            second_precision=interval.second_precision,
        )
...
class TIMESTAMP(sqltypes.TIMESTAMP):
    ...
    def __init__(self, timezone: bool = False, local_timezone: bool = False):
        ...
        if timezone and local_timezone:
            raise exc.ArgumentError("timezone and local_timezone are mutually exclusive")
