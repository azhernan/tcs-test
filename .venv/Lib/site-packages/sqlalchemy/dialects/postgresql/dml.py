...
class Insert(StandardInsert):
    ...
    def on_conflict_do_nothing(
        ...
        """
        self._post_values_clause = OnConflictDoNothing(constraint, index_elements, index_where)
        return self
    ...
    def __init__(
        ...
        if constraint is not None:
            if index_elements is not None:
                raise ValueError("'constraint' and 'index_elements' are mutually exclusive")
...
class OnConflictDoUpdate(OnConflictClause):
    ...
    def __init__(
        ...
        self.update_values_to_set = [
            (coercions.expect(roles.DMLColumnRole, key), value) for key, value in set_.items()
        ]
