...
class Query(
    ...
    def add_entity(
        ...
        self._raw_columns.append(
            coercions.expect(roles.ColumnsClauseRole, entity, apply_propagate_attrs=self)
        )
        return self
    ...
    def order_by(
        ...
        *clauses: _ColumnExpressionOrStrLabelArgument[Any],
        ...
        if not clauses and (__first is None or __first is False):
            ...
            criterion = tuple(
                coercions.expect(roles.OrderByRole, clause) for clause in (__first,) + clauses
            )
    ...
    def group_by(
        ...
        *clauses: _ColumnExpressionOrStrLabelArgument[Any],
        ...
        if not clauses and (__first is None or __first is False):
            ...
            criterion = tuple(
                coercions.expect(roles.GroupByRole, clause) for clause in (__first,) + clauses
            )
