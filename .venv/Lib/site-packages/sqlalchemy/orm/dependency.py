...
class DependencyProcessor:
    ...
    def per_state_flush_actions(self, uow, states, isdelete):
        ...
        for state in states:
            ...
            sum_ = state.manager[self.key].impl.get_all_pending(
                state,
                state.dict,
                (self._passive_delete_flag if isdelete else attributes.PASSIVE_NO_INITIALIZE),
            )
    ...
    def prop_has_changes(self, uowcommit, states, isdelete):
        ...
        for s in states:
            ...
            return (
                states and not self.prop._is_self_referential and self.mapper in uowcommit.mappers
            )
    ...
    def per_property_preprocessors(self, uow):
        if self.prop._reverse_property:
            if self.passive_updates:
                ...
                if False in (prop.passive_updates for prop in self.prop._reverse_property):
                    return
