...
def _check_not_declarative(cls: Type[Any], base: Type[Any]) -> None:
    ...
    if (
        ...
        and not (callable(cls_dict["__table__"]) or hasattr(cls_dict["__table__"], "__get__"))
    ...
    * :meth:`_orm.registry.map_imperatively` will produce a
    ...
    def _resolve_type(self, python_type: _MatchedOnType) -> Optional[sqltypes.TypeEngine[Any]]:
        ...
        if is_generic(python_type_to_check):
            ...
            search = ((pt if check_is_pt else python_type, pt) for pt in python_type_type.__mro__)
        else:
