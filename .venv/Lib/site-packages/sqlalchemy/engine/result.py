...
class ResultInternal(InPlaceGenerative, Generic[_R]):
    ...
    def _unique_strategy(self) -> _UniqueFilterStateType:
        ...
        real_result = (
            self._real_result if self._real_result is not None else cast("Result[Any]", self)
        )
...
class MergedResult(IteratorResult[_TP]):
    ...
    def __init__(self, cursor_metadata: ResultMetaData, results: Sequence[Result[_TP]]):
        ...
        self._attributes = self._attributes.merge_with(*[r._attributes for r in results])
